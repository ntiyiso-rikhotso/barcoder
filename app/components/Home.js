...
const baseUrl = "https://newdev.itntdev.co.za/ntiyiso/www.scanapp.co.za/";

/* Components */
import Welcome from './welcomeLoader/Welcome'; //loader
...
export default class App extends Component {
  ...
  async _loadAssetsAsync() {
	...
	_images.push(require("../images/logo.png"))
	_images.push(require("../images/icon.png"))
        ...
        <Container>
          ...
          <Content>
            {this.state.component == "home" ? (
              <History scan={this.scan.bind(this)}/>
    ...
    return (
	  ...
	  <View style={styles.containerLogin}>
	   <KeyboardAvoidingView style={{alignItems: 'center', paddingTop: deviceHeight*0.11}} behavior='position' keyboardVerticalOffset={keyboardVerticalOffset}>
        <Image style={styles.login} source={require("../images/logo.png")} />
